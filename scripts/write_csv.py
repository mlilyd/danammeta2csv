'''
Deprecated python module for exporting CSV for transfer. The only function still used from this module is 
the list_from_txt function.
'''
import json
import codecs
import argparse
...
'''
read monument id from a simple txt file (one id per line). 
input: filename of the text file
output: an array of IDs (strings)

Lines can be commented with #. Empty lines will be skipped
'''
